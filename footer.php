...
?>
    <footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <div class="site-info">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-2 hidden-sm-down left-align">
                        <img src="/wp-content/themes/onepress/assets/images/logo-white.png"/>
                    </div>
                    <div class="col-md-2 left-align col-sm-4 col-xs-6" style="padding-top:10px;">
                        <div><a href="/index.php/sitemap/">GLORY TAPES</a></div>
                        <div>TEL:&nbsp;+86 5738 3679 953</div>
                    </div>
                    <div class="col-md-2 left-align col-sm-4 col-xs-6" style="padding-top:10px;">
                        <div><a href="http://www.glorytapes.com">www.glorytapes.com</a></div>
                        <div>FAX:&nbsp;+86 5738 3198 277</div>
                    </div>
                    <div class="col-md-5 col-sm-2">
                    </div>
                    <div class="col-md-1 col-sm-2 hidden-xs-down">
                        <a class="back-top-top" href="#page" title="<?php echo esc_html__('Back To Top', 'onepress') ?>">
                            <i class="fa fa-4x fa-angle-double-up wow flash" data-wow-duration="2s"></i>
                        </a>
                    </div>
                </div>
            </div>
