...
function my_taxonomies_product() {
	$labels = array(
		...
		'menu_name'         => __( 'Product Categorys' ),
	);
	$args = array(
		'labels' => $labels,
		'hierarchical' => true,
...
function my_custom_post_origin() {
  $labels = array(
    'name'               => _x( 'Origins'),
    'singular_name'      => _x( 'Origin'),
    'add_new'            => _x( 'Add New'),
    'add_new_item'       => __( 'Add New Origin' ),
    'edit_item'          => __( 'Edit' ),
    'new_item'           => __( 'Add New' ),
    'all_items'          => __( 'All Origins' ),
    'view_item'          => __( 'View Origin' ),
    'search_items'       => __( 'Search Origins' ),
    'not_found'          => __( 'No Origin' ),
    'not_found_in_trash' => __( 'No posts found in Trash.' ),
    'parent_item_colon'  => 'Parent:',
    'menu_name'          => 'Origins'
  );
  ...
  register_post_type( 'origin', $args );
}
add_action( 'init', 'my_custom_post_origin' );

function my_custom_post_testimonial() {
  $labels = array(
    'name'               => _x( 'Testimonials'),
    'singular_name'      => _x( 'Testimonial'),
    'add_new'            => _x( 'Add New'),
  ...
  $args = array(
    'labels'        => $labels,
    'description'   => 'Testimonial information',
    'public'        => true,
    'menu_position' => 5,
    'supports'      => array( 'title', 'editor', 'thumbnail', 'excerpt'),
    'has_archive'   => true
...
function my_custom_post_application() {
  $labels = array(
    'name'               => _x( 'Applications'),
    'singular_name'      => _x( 'Application'),
    'add_new'            => _x( 'Add New'),
...
add_action( 'init', 'my_custom_post_application' );my_custom_post_application
*/

function my_custom_post_employee() {
  $labels = array(
    'name'               => _x( 'Employees'),
    'singular_name'      => _x( 'Employee'),
    'add_new'            => _x( 'Add New'),
...
function my_taxonomies_employee() {
	$labels = array(
		'name'              => _x( 'Employee Categories'),
		'singular_name'     => _x( 'Employee Category'),
		'search_items'      => __( 'Search Categories' ),
		...
		'menu_name'         => __( 'Employee Categorys' ),
	);
	$args = array(
		'labels' => $labels,
		'hierarchical' => true,
...
function onepress_scripts() {
	...
	//wp_enqueue_script( 'onepress-js-chartjs', get_template_directory_uri() . '/assets/js/Chart.min.js', array(), '1.0.1', true );
