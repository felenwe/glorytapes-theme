            ...
            <div class="container">
                <div class="section-title-area">
                    <?php if ( $desc = get_theme_mod( 'onepress_services_desc' ) ) {
                        ...
                        echo '<img src="' .wp_kses_post($desc) .'"/>';
                    } ?>
                            ...
                            <div class="<?php echo esc_attr( $classes ); ?> wow slideInUp">
                                <div class="service-item ">
                                    ...
                                    <?php if ( has_post_thumbnail() ) { ?>
                                        <div class="service-thumbnail col-md-4 col-sm-12 col-lg-3 col-xs-12">
                                            <?php
                                    ...
                                    <?php } ?>
                                    -->
                                    <div class="service-content col-md-8 col-sm-12 col-lg-9 col-xs-12">
