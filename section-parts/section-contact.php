...
if ( $onepress_contact_cf7 || $onepress_contact_text || $onepress_contact_address_title || $onepress_contact_phone || $onepress_contact_email || $onepress_contact_fax ) {
    ...
    <?php if (!$onepress_contact_disable) : ?>
        <section style="background:#ffffff;" id="<?php if ($onepress_contact_id != '') echo $onepress_contact_id; ?>" <?php do_action('onepress_section_atts', 'counter'); ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-8 wow slideInUp">
                        <!--<br>-->
                        ...
                        <div class="address-box">
                            ...
                            <img src="/wp-content/themes/onepress/assets/images/website.png" class="col-sm-2 col-xs-4 right-float"/>
                            <img src="/wp-content/themes/onepress/assets/images/map.jpg" class="col-sm-6"/>
                </div>
            </div>
