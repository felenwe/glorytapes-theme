    ...
    <?php if ( ! $onepress_team_disable ) : ?>
        <section id="<?php if ($onepress_team_id != '') echo $onepress_team_id; ?>" <?php do_action('onepress_section_atts', 'team'); ?>
            ...
            <div class="container">
                ...
                <div class="team-members row" style="white-space:nowrap;padding-top:250px;height:360px;background:url('<?php echo wp_kses_post($desc);?>')">
                    <?php
                    if (!empty($user_ids)) {
                        $n = 0;
                        foreach ($user_ids as $member) {
                            ...
                            if ( $image_attributes ) {
                                ...
                                ?>
                                <?php if ( $link ) { ?>
                                    <a href="<?php echo esc_url( get_permalink($link) ); ?>">
                                <?php } ?>
