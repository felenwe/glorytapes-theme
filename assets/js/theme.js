...
( function() {
    ...
    jQuery('.home #site-navigation li a[href*=#]').on('click', function(event){
        ...
        if(target_url.indexOf(location_url+'#')==0 || target_url.indexOf(location_url+'/#')==0) {
            event.preventDefault();
    ...
    // Navigation click to section.
    jQuery('.page-template-template-contact #site-navigation li a[href*=#]').on('click', function(event){
        var target_url = event.target+'';
        var location_url = document.location.href+'';
        if(location_url.indexOf('#') != -1)
            location_url = location_url.substring(0, location_url.indexOf('#'));
    ...
    // Navigation click to section.
    jQuery('.page-template-template-product .sidebar li a[href*=#]').on('click', function(event){
        var target_url = event.target+'';
        var location_url = document.location.href+'';
        if(location_url.indexOf('#') != -1)
            location_url = location_url.substring(0, location_url.indexOf('#'));
